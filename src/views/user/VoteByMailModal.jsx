                ...
                {({ loading, error, data: { dataDates } }) => {
                  ...
                  return (
                    <div className="notification is-warning">
                      {dataDates.earlyVoteDataDate ? (
                        <div>
                          Vote By Mail information is complete as of{' '}
                          {distanceInWordsToNow(parse(dataDates.earlyVoteDataDate))} ago.{' '}
                        </div>
                      ) : (
                        <span>
              ...
              (cycle === 'general' && !potentialVoter.voterFileRecord.vo_ab_requested_general) ? (
                <div>
                  <p>
                    ...
                    We recommend you encourage your contacts to vote by mail for several reasons:
                  </p>
                  <ul>
